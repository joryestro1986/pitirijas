...
/*----------------------------------------*/
 ...
 /*----------------------------------------*/
    ...
    //$('.ht-setting-trigger.is-active').attr("data-toggle", "modal");
    //$('.ht-setting-trigger.is-active').attr("data-target", "#qvCart");
...
/*----------------------------------------*/ 
	...
	// showlogin toggle
		$('#ship-box').on('click', function() {
			...
			//$("input[id$='shipboxinfo']").slideToggle(1000);
		});
/*----------------------------------------*/
/* 15. Li's Blog Gallery Slider
/*----------------------------------------*/ 
...
/*----------------------------------------*/
	...
	if (!myPageName.includes("shoppingCart")) {
